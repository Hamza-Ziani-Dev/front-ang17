...
@Component({
  selector: 'app-update-privilege-document-dialog',
  standalone: true,
  imports: [CommonModule,MaterialModuleModule,FormsModule],
  templateUrl: './update-privilege-document-dialog.component.html',
  styleUrl: './update-privilege-document-dialog.component.scss'
})
export class UpdatePrivilegeDocumentDialogComponent {
