...
@Component({
  selector: 'app-update-privilege-courrier-dialog',
  standalone: true,
  imports: [CommonModule,MaterialModuleModule,FormsModule],
  templateUrl: './update-privilege-courrier-dialog.component.html',
  styleUrl: './update-privilege-courrier-dialog.component.scss'
})
export class UpdatePrivilegeCourrierDialogComponent {
