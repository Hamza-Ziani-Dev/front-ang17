...
@Component({
  selector: 'app-add-privilege-courrier-dialog',
  standalone: true,
  imports: [CommonModule,MaterialModuleModule,FormsModule],
  templateUrl: './add-privilege-courrier-dialog.component.html',
  styleUrl: './add-privilege-courrier-dialog.component.scss'
})
export class AddPrivilegeCourrierDialogComponent {
