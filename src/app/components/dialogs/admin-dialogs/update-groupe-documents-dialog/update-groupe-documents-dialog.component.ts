...
@Component({
  selector: 'app-update-groupe-documents-dialog',
  standalone: true,
  imports: [CommonModule,MaterialModuleModule,FormsModule],
  templateUrl: './update-groupe-documents-dialog.component.html',
  styleUrl: './update-groupe-documents-dialog.component.scss'
})
export class UpdateGroupeDocumentsDialogComponent {
