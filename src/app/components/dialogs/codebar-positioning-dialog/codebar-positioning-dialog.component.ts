...
@Component({
  selector: 'app-codebar-positioning-dialog',
  standalone: true,
  imports: [CommonModule, FormsModule,PdfViewerModule,MaterialModuleModule],
  templateUrl: './codebar-positioning-dialog.component.html',
  styleUrl: './codebar-positioning-dialog.component.scss'
})
export class CodebarPositioningDialogComponent implements OnInit, AfterViewInit {
    @Input() pdfSrc: string = '';
    @Input() refval: string = '';
    @Input() cbval: string = '';
    ...
    constructor(
      private dialogRef: MatDialogRef<CodebarPositioningDialogComponent>,
