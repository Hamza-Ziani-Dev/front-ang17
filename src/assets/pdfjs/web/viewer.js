...
function webViewerLoad() {
  ...
  var searchFullText = sessionStorage.getItem("last_full_text");
   //console.log("viewer",searchFullText)
  if(searchFullText!=null && searchFullText!= undefined ) 
  {
    if(searchFullText.length>0)
    {
     ...
     var findBar = config.findBar;
     findBar.bar.classList.remove("hidden");
     findBar.findField.value = searchFullText;
     setTimeout(()=>{findBar.findField.dispatchEvent(new Event("input"));},300)
